  ...
  return (
    <Container className="introduction">
      ...
      <div className="section overview">
        <h3>Update</h3>
        <p>
          For update the admin panel just upload your update zip file in your
          project root folder and extract it. Hit the domain or refresh. There
          will be a Update button, just click and you are done.
        </p>
      </div>
      <div className="section overview">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-build-code-and-setup-on-server-4', {
                replace: true,
              });
            }}
            className="me-3"
          ...
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-app-web-5', {
                replace: true,
              });
            }}
          >
