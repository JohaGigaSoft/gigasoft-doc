...
import { mobileApp } from '../../data/unorderList/restFood/mobileApp';
    ...
    <Container className="introduction">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-server-0', { replace: true });
            }}
            className="me-3"
          >
          ...
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-flutter-sdk-1', { replace: true });
            }}
          >
