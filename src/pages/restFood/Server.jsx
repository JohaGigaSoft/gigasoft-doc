...
import { server } from '../../data/unorderList/restFood/server';
    ...
    <Container className="introduction">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-basic-0', { replace: true });
            }}
            className="me-3"
          >
          ...
          <button
            onClick={() => {
              navigate('/doc-rest-food/rest_food-mobile-app-0', { replace: true });
            }}
          >
