...
import {
  countryFilterOne,
  countryFilterTwo,
} from '../../data/unorderList/gigaMart/mobileApp';
import {
  appColor,
  appFont,
  localLanguage,
} from '../../data/unorderList/gigaMart/mobileCustomization';
    ...
    <Container className="introduction">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-mandatory-setup-3', {
                replace: true,
              });
            }}
            className="me-3"
          ...
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-app-build-release-3', {
                replace: true,
              });
            }}
          >
