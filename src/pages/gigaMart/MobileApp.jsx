...
import { mobileApp } from '../../data/unorderList/gigaMart/mobileApp';
    ...
    <Container className="introduction">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-server-0', { replace: true });
            }}
            className="me-3"
          >
          ...
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-flutter-sdk-1', { replace: true });
            }}
          >
