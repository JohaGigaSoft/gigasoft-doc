...
import { server } from '../../data/unorderList/gigaMart/server';
    ...
    <Container className="introduction">
      ...
      <div className="d-flex justify-content-end">
        <div className="btn-pre-next">
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-basic-0', { replace: true });
            }}
            className="me-3"
          >
          ...
          <button
            onClick={() => {
              navigate('/doc-giga-mart/giga_mart-mobile-app-0', { replace: true });
            }}
          >
